...
// размещает и возвращает матрицу размером nRows на nCols
matrix getMemMatrix(int nRows, int nCols);

// размещает массив из nMatrices матриц
// размером nRows на nCols. Возвращает
// указатель на нулевую матрицу.
...
// обмен строк с порядковыми номерами
// j1 и j2 в матрице m
void swapRows(matrix m, int i1, int i2);

// обмен колонок с порядковыми номерами
// j1 и j2 в матрице m
